...
import PhotographerProfilePage from "@/features/photographer-profile/pages/PhotographerProfilePage"
  ...
  return (
    <Routes>
      <Route path="/" element={<CosplayerSiteLayout />}>
        ...
        <Route path="photographer" element={<PhotographerProfilePage />} />
