...
export const VI = {
  ...
  profile: {
    ...
    orders: {
      ...
      reviewModal: {
        ...
        readOnlyTitle: "Đánh giá của bạn",
        ...
        uploadHint: "Bấm hoặc kéo thả ảnh vào đây",
        uploadSupport: "Hỗ trợ nhiều ảnh (JPG, PNG)",
        submit: "Gửi đánh giá",
        cancel: "Hủy",
      },
    ...
    serviceOrders: {
      ...
      toastWalletPaySuccess: "Thanh toán thành công!",
    ...
    servicePayment: {
      ...
      btnPayingWallet: "Đang thanh toán...",
    },
  },
  ...
  booking: {
    create: {
      ...
      create: "Tạo đơn đặt",
      creating: "Đang tạo...",
      success: "Tạo đơn dịch vụ thành công!",
