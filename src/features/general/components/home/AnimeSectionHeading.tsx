    ...
    >
      <div className="min-w-0 flex-1 space-y-3">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <h2 className="text-[1.35rem] font-extrabold leading-tight tracking-tight text-indigo-950 md:text-[1.75rem]">
        ...
        {description ? (
          <p className="max-w-xl rounded-2xl border-[3px] border-indigo-950 bg-[#fffbeb] px-4 py-3 text-sm font-semibold leading-relaxed text-indigo-950 shadow-[6px_6px_0_0_rgba(30,27,75,0.75)]">
            {description}
          </p>
        ) : null}
      </div>
