...
export function PhotographerCard({
  ...
  const tag = description?.trim() ? `#${description.slice(0, 22)}` : "#PHOTOGRAPHER"
  ...
  return (
    ...
    >
      <Link to={`/photographer/${id}`} className="block text-left outline-none focus-visible:ring-4 focus-visible:ring-pink-400 rounded-[calc(1.05rem-2px)]">
