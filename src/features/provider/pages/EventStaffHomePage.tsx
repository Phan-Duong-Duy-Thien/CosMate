    ...
    <DashboardLayout title={VI.provider.dashboardEventStaff.title} sidebarItems={sidebarItems} brandName="CosMate Event Staff" showChatButton={false}>
        <>
          <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
            <div>
              <h2 style={{ fontSize: 20, fontWeight: 600, marginBottom: 4 }}>{VI.provider.dashboardEventStaff.welcome}</h2>
              <p className="text-muted-foreground text-[13px]">{VI.provider.dashboardEventStaff.overview}</p>
            </div>
            <Space>
